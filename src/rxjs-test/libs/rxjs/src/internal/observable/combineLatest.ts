...
import { Observable, operate, from } from "src/rxjs-test/libs/observable/src";
import type {
  ObservableInput,
  ObservedValueOf,
...
import type { AnyCatcher } from "../AnyCatcher";
 ...
 */
export function combineLatest<T extends AnyCatcher>(
  arg: T
): Observable<unknown>;
