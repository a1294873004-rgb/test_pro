...
import { Observable, from, operate } from "src/rxjs-test/libs/observable/src";
import type { ObservableInput, ObservableInputTuple } from "../types";
...
export function race<T>(
  ...
  return sources.length === 1
    ? from(sources[0] as ObservableInput<T>)
