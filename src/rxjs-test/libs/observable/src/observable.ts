 ...
 * @param subscriber
 */
export function subscribeToArray<T>(
  array: ArrayLike<T>,
  subscriber: Subscriber<T>
) {
...
export function createNotification<T>(
  ...
  value: T,
  error: undefined
): { kind: "N"; value: T; error: undefined };
export function createNotification<T>(
  kind: "E",
  value: undefined,
  error: any
): { kind: "E"; value: undefined; error: any };
export function createNotification<T>(
  kind: "C",
  value: undefined,
  error: undefined
): { kind: "C"; value: undefined; error: undefined };
export function createNotification<T>(
  kind: "N" | "E" | "C",
  value: T | undefined,
  error: any
