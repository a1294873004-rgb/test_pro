...
export class TestAffineEditorContainer extends SignalWatcher(
  ...
  set doc(doc: Store) {
    this._doc.value = doc;
    this._applyReadonly(this.readonly, doc);
  }
  ...
  private _applyReadonly(readonly: boolean, doc?: Store) {
    const target = doc ?? this._doc.value;
    if (!target) {
      return;
    }
...
declare global {
  interface HTMLElementTagNameMap {
    "test-affine-editor-container": TestAffineEditorContainer;
  }
}
